      ...
      <ul class="topnav">
        ...
        <li style="float: right; color: white;"><a href=""><i class="fas fa-globe-europe"></i><div id="ausgabe"></div></a></li>
          ...
          <form action="../../php/warenkorb.php" method="post">
            <div class="media">
              <img src="../../images/Für Pferde/halfter.jpg" class="mr-3" width="370" height="370" border="0" alt="Halfter">
                <div class="media-body">
                  <h3 class="mt-0">Halfter</h3><br><br>
                    Mit schicker Applikation am Nasenriemen. Das weiche Neopren-Polster bietet optimalen Scheuerschutz auf sensiblen Belastungspunkten. Das Halfter ist sowohl am Kinn- als auch am Genickstück durch stabile Dornschnallen individuelle verstellbar. Alle Metallbeschläge sind markant kupferfarbend veredelt. <br><br>
                    Produkt-ID: 1001 <br>
                    Größe: Universal <br>
                    Preis: 30€ <br><br>
                    
                    <a href="../../php/cart.php?id=1001" style="color: green;">In den Warenkorb</a>
                </div>
