      ...
      <ul class="topnav">
        ...
        <li style="float: right; color: white;"><a href=""><i class="fas fa-globe-europe"></i><div id="ausgabe"></div></a></li>
  		...
  		<div class="container">
            ...
            <div class="media">
              <img src="../../images/Für Pferde/Paradedecke.jpg" class="mr-3" width="370" height="370" border="0" alt="Paradedecke">
                <div class="media-body">
                  <h3 class="mt-0">Paradedecke</h3><br><br>
                    Wunderschöne, bestickbare Paradedecke von Horse-friends für tolle Auftritte. Das saugfähige Material leitet den Schweiß nach außen und schützt dabei Ihr Pferd vor Kälte und Zugluft. Es ist atmungsaktiv, schweißableitend und klimaregulierend. Die Besonderheiten der Paradecke sind der aufwendig gearbeitete Zierschweifriemen, die umlaufende Kontrastkordel und der Brustlatz. Für besten Halt sorgen der doppelte Brustverschluss und der Schweifriemen.<br><br>
                    Produkt-ID: 1004 <br>
                    Größe: S = 125 cm <br>
                    Preis: 25€ <br><br>
                    <a href="../../php/cart.php?id=1004" style="color: green;">In den Warenkorb</a>
                </div>
