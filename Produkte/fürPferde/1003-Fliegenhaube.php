      ...
      <ul class="topnav">
        ...
        <li style="float: right; color: white;"><a href=""><i class="fas fa-globe-europe"></i><div id="ausgabe"></div></a></li>
  		...
  		<div class="container">
            ...
            <div class="media">
              <img src="../../images/Für Pferde/Fliegenhaube.jpg" class="mr-3" width="370" height="370" border="0" alt="Fliegenhaube">
                <div class="media-body">
                  <h3 class="mt-0">Fliegenhaube</h3><br><br>
                    Die Fliegenhaube Artwork aus der aktuellen Heritage Kollektion von ESKADRON ist ein gehäkelter Fliegenkopfschutz mit elastischen Ohren. Sie bietet nicht nur im Sommer Schutz vor Lästlingen, sondern in Kombination mit den drei umlaufenden Kordeln und der Stickerei auch perfekt mit der passenden Schabracke zu kombinieren.<br><br>
                    Produkt-ID: 1003 <br>
                    Größe: Universal <br>
                    Preis: 35€ <br><br>
                    <a href="../../php/cart.php?id=1003" style="color: green;">In den Warenkorb</a>
                </div>
