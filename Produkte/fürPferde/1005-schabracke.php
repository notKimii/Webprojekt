      ...
      <ul class="topnav">
        ...
        <li style="float: right; color: white;"><a href=""><i class="fas fa-globe-europe"></i><div id="ausgabe"></div></a></li>
  		...
  		<div class="container">
            ...
            <div class="media">
              <img src="../../images/Für Pferde/Schabracke.jpg" class="mr-3" width="370" height="370" border="0" alt="Schabracke">
                <div class="media-body">
                  <h3 class="mt-0">Schabracke</h3><br><br>
                    Die Schabracke Big Square aus der aktuellen Heritage Kollektion von ESKADRON. Sie ist die absolute Topseller Schabracke in voluminöser Big-Square-Steppung. Die Abseite besteht aus fellfreundlichem Baumwollwaffel-Gewebe. Durch die schicke Doppelkordel und den beidseitig vertikalen Emblemstreifen wird die Big Square Schabracke zu einem echten Eyecatcher und zum absoluten Must-have der Heritage Kollektion.<br><br>
                    Produkt-ID: 1005 <br>
                    Größe: S = 60 cm x 56 cm <br>
                    Preis: 50€ <br><br>
                    <a href="../../php/cart.php?id=1005" style="color: green;">In den Warenkorb</a>
                </div>
