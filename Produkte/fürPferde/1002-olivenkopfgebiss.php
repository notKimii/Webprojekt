      ...
      <ul class="topnav">
        ...
        <li style="float: right; color: white;"><a href=""><i class="fas fa-globe-europe"></i><div id="ausgabe"></div></a></li>
  		...
  		<div class="container">
            ...
            <div class="media">
              <img src="../../images/Für Pferde/Olivenkopfgebiss.jpg" class="mr-3" width="370" height="370" border="0" alt="Olivenkopfgebiss">
                <div class="media-body">
                  <h3 class="mt-0">Olivenkopfgebiss</h3><br><br>
                    Olivenkopfgebiss aus Edelstahl. Das ergonomisch geformte Mundstück des Olivenkopfgebisses liegt besonders weich und angenehm im Pferdemaul.<br><br>
                    Produkt-ID: 1002 <br>
                    Größe: S = 16mm <br>
                    Preis: 20€ <br><br>
                    <a href="../../php/cart.php?id=1002" style="color: green;">In den Warenkorb</a>
                </div>
