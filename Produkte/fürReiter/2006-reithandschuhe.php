    ...
    <!--Kopf--> 
      ...
      <div class="container">
        <form action="../../php/warenkorb.php" method="post">
            <div class="media">
              <img src="../../images/Für Reiter/Reithandschuhe.jpg" class="mr-3" width="370" height="370" border="0" alt="Reithandschuhe">
                <div class="media-body">
                  <h3 class="mt-0">Reithandschuhe</h3><br><br>
                   Unser Bestseller in der Wintervariante mit Fleecelaminierung! Die Winter-Reithandschuhe Light & Soft zeichnen sich besonders durch ihre Leichtigkeit und das weiche, griffige Kunstledermaterial aus. Für eine ausgezeichnete Passform und optimale Bewegungsfreiheit sorgen die Dehnungsfalten an Fingern und Handrücken sowie der Gummizug an Handrücken und Bündchen. <br><br>
                    Produkt-ID: 2006 <br>
                    Größe: S <br>
                    Preis: 10€ <br><br>
                    <a href="../../php/cart.php?id=2006" style="color: green;">In den Warenkorb</a>
                </div>
