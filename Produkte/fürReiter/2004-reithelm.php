    ...
    <!--Kopf--> 
      ...
      <div class="container">
        <form action="../../php/warenkorb.php" method="post">
            <div class="media">
              <img src="../../images/Für Reiter/reithelm.jpg" class="mr-3" width="370" height="370" border="0" alt="Reithelm">
                <div class="media-body">
                  <h3 class="mt-0">Reithelm</h3><br><br>
                    Der Leichte und Luftige - Unschlagbar im Preis/Leistungsverhältnis! Praktisch und bequem im täglichen Gebrauch. Rundum sicher, mit 4-fach Monocoque™- Sicherheitstechnik. Effiziente Fresh-Air-Belüftung durch 13 Lüftungsöffnungen mit schönen Edelstahl Eyelets.<br><br>
                    Produkt-ID: 2004 <br>
                    Größe: S =  54-56 cm <br>
                    Preis: 100€ <br><br>
                    <a href="../../php/cart.php?id=2004" style="color: green;">In den Warenkorb</a>
                </div>
