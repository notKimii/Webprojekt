    ...
    <!--Kopf--> 
      ...
      <div class="container">
        <form action="../../php/warenkorb.php" method="post">
            <div class="media">
              <img src="../../images/Für Reiter/reithose.jpg" class="mr-3" width="370" height="370" border="0" alt="Reiter">
                <div class="media-body">
                  <h3 class="mt-0">Reithose</h3><br><br>
                    Unser Bestseller die Winterreithose Genua Winter von black forest in neuer Passform. Durch das Baumwoll-Material und die weich angeraute Fleece-Fütterung ist die Gesäßeinsatz-Reithose Genua auch bei kalten Temperaturen genau die richtige Wahl!<br><br>
                    Produkt-ID: 2002 <br>
                    Größe: S <br>
                    Preis: 55€ <br><br>
                    <a href="../../php/cart.php?id=2002" style="color: green;">In den Warenkorb</a>
                </div>
