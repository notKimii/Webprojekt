    ...
    <!--Kopf--> 
      ...
      <div class="container">
        <form action="../../php/warenkorb.php" method="post">
            <div class="media">
              <img src="../../images/Für Reiter/Outdoorjacke.jpg" class="mr-3" width="370" height="370" border="0" alt="Outdoorjacke">
                <div class="media-body">
                  <h3 class="mt-0">Outdoorjacke</h3><br><br>
                    Die Reit- und Outdoorjacke Sintra von black forest ist ein praktischer Allrounder für Sport und Freizeit. Aus angenehm zu tragendem Polyester-Material, das atmungsaktiv (Atmungsaktivität 3.000 g/m²) und wasserdicht (Wassersäule 3.000 mm) ist. <br><br>
                    Produkt-ID: 2001 <br>
                    Größe: S <br>
                    Preis: 60€ <br><br>
                    <a href="../../php/cart.php?id=2001" style="color: green;">In den Warenkorb</a>
                </div>
