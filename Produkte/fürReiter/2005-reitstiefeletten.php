  ...
  <body>
    <!--Kopf--> 
      ...
      <div class="container">
        <form action="../../php/warenkorb.php" method="post">
            <div class="media">
              <img src="../../images/Für Reiter/Reitstiefeletten.jpg" class="mr-3" width="370" height="370" border="0" alt="Reitstiefeletten">
                <div class="media-body">
                  <h3 class="mt-0">Reitstiefelletten</h3><br><br>
                   Das robuste, rustikale Fettleder mit echtem Lammfellfutter ist die perfekte Kombination für die kalten Tage. Des Weiteren ist die Winter-Reitstiefelette mit Gummieinsätzen am Schaft für ein bequemes An- und Ausziehen sowie einer rutschfesten Gummiprofilsohle ausgestattet. <br><br>
                    Produkt-ID: 2005 <br>
                    Größe: 38 <br>
                    Preis: 65€ <br><br>
                    <a href="../../php/cart.php?id=2005" style="color: green;">In den Warenkorb</a>
                </div>
    ...
    <!--Fußzeile-->
      ...
      <center><footer class="col-sm" style="background-color:  #D8D8D8;"><br>
        <a href="../../php/fuerreiter.php" style="color: black;">- Zurück nach oben -</a>
